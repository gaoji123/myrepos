...
<template>
  <div class="">
        ...
        <el-col :span="24">
          ...
          <div class="headBox">
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
              ...
              <el-menu-item index="/Reward"><i class="fa fa-wa fa-cny"></i> 了解开发者</el-menu-item>
              <el-menu-item index="/Friendslink"><i class="fa fa-wa fa-users"></i>知识链接</el-menu-item>
    ...
    <div class="headImgBox"
         :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/myheader.jpg)'}">
      <div class="scene">
      ...
      <div class="h-information">
        ...
        <img
          :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/gcf.png'"
          alt="">

        <h2 class="h-description">

          {{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "垃圾分类系统" }}
