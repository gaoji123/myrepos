        ...
        <div class="detailBox tcommonBox" >
            ...
            <div class="donate">
                <div class="donate-word">
                    <span @click="pdonate=!pdonate">了解开发者</span>
                </div>
                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
                    <el-col  :span="12"   class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/wx.png'" :onerror="$store.state.errorImg"/>
                            <span>通过微信，联系我</span>
                        </div>
                    </el-col>
                    <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/qqaboutme.png'" :onerror="$store.state.errorImg"/>
                            <span>通过QQ了解我</span>
                        </div>
                    </el-col>
                </el-row>
